...
Begin DesktopWindow AboutWindow
   ...
   Visible         =   True
   Width           =   342
   Begin DesktopImageViewer IconImageViewer
      Active          =   False
   ...
   Begin DesktopLabel CopyrightLabel
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Copyright © 2023 University of Kent"
      TextAlignment   =   1
      TextColor       =   &c000000
      Tooltip         =   ""
      Top             =   136
      ...
      Width           =   302
   End
   Begin DesktopLabel StaticLabel
      AllowAutoDeactivate=   True
      Bold            =   False
      Enabled         =   True
      FontName        =   "System"
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "This software is built with Xojo from Xojo, Inc."
      TextAlignment   =   0
      TextColor       =   &c000000
      Tooltip         =   ""
      Top             =   168
	...
	#tag Event
		Sub Opening()
		  ...
		  If TargetMacOS = True or TargetLinux = true then
		    AppNameLabel.Text = App.ExecutableFile.Name
		  Else
		    AppNameLabel.Text = Left(App.ExecutableFile.Name, Len(App.ExecutableFile.Name) - 4)
		  End If
		  
		  VersionLabel.Text = "Version " + Str(App.MajorVersion) + "." + str(App.MinorVersion) + "." +  str(App.BugVersion)
		  VersionLabel.Text = VersionLabel.Text + " - Built on " + RBVersionString + " - " + App.BuildDate.ShortDate
		  
		  CopyrightLabel.Text = App.Copyright
		  
		  StaticLabel.Text = "This program is built with Xojo from Xojo, Inc."
		End Sub
	#tag EndEvent
