...
Begin Menu MainMenuBar
   Begin DesktopMenuItem FileMenu
      ...
      Begin DesktopApplicationMenuItem AboutItem
         ...
         Visible = True
      End
      Begin DesktopApplicationMenuItem AboutSeparator
         SpecialMenu = 0
         Index = -2147483648
         Text = "-"
         AutoEnabled = True
         ...
         Visible = True
      End
      Begin DesktopPreferencesMenuItem SettingsItem
         SpecialMenu = 0
         Index = -2147483648
         Text = "Settings..."
         AutoEnabled = True
         ...
         Visible = True
      End
      Begin DesktopMenuItem FileSeparator
         SpecialMenu = 0
         Index = -2147483648
         Text = "-"
         AutoEnabled = True
   ...
   Begin DesktopMenuItem EditMenu
      ...
      Begin DesktopMenuItem EditUndo
         ...
         Visible = True
      End
      Begin DesktopMenuItem ClipboardSeparator
         SpecialMenu = 0
         Index = -2147483648
         Text = "-"
         AutoEnabled = True
      ...
      Begin DesktopMenuItem EditClear
         ...
         Visible = True
      End
      Begin DesktopMenuItem SelectionSeparator
         SpecialMenu = 0
         Index = -2147483648
         Text = "-"
         AutoEnabled = True
