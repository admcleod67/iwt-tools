...
#define XojoAppName            "TaxonomicSearch"
; XojoProjectName is the name of the project file, including its extension.
#define XojoProjectName        "TaxonomicSearch.xojo_binary_project"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID from the menu.)
AppId={{FC28C971-1299-4CCE-99BF-C6C950596B4F}}
AppName={#XojoAppName}
AppVerName={#XojoAppName} 1.0.8
AppPublisher=Xojo, Inc.
AppPublisherURL=
AppSupportURL=
AppUpdatesURL=
DefaultDirName={userpf}\\{#XojoAppName}
DefaultGroupName={#XojoAppName}
; save installer file alongside this script
OutputDir=".\\Builds - {#XojoAppName}\\Windows 64 bit\\"
OutputBaseFilename=Setup{#XojoAppName}x64
...
Name: "{userdesktop}\\{#XojoAppName}"; Filename: "{app}\\{#XojoAppName}.exe"; Tasks: desktopicon;
...
[Files]
Source: ".\\Builds - {#XojoAppName}\\VC_redist.x64.exe"; DestDir: {tmp}
