...
VALUES (1, 'Shopee Indonesia', 'https://shopee.co.id/search?keyword=${searchTerms}', 1);
INSERT INTO site (id, name, url, active)
VALUES (2, 'Shopee Malaysia', 'https://shopee.com.my/search?keyword=${searchTerms}', 0);
INSERT INTO site (id, name, url, active)
VALUES (3, 'Shopee Singapore', 'https://shopee.sg/search?keyword=${searchTerms}', 1);
INSERT INTO site (id, name, url, active)
VALUES (4, 'Shopee Taiwan', 'https://shopee.tw/search?keyword=${searchTerms}', 0);
INSERT INTO site (id, name, url, active)
VALUES (5, 'Shopee Vietnam', 'https://shopee.vn/search?keyword=${searchTerms}', 0);
INSERT INTO site (id, name, url, active)
VALUES (6, 'Shopee Thailand', 'https://shopee.co.th/search?keyword=${searchTerms}', 0);
INSERT INTO site (id, name, url, active)
VALUES (7, 'Shopee Philippines', 'https://shopee.ph/search?keyword=${searchTerms}', 0);
INSERT INTO site (id, name, url, active)
VALUES (8, 'Shopee Brazil', 'https://shopee.com.br/search?keyword=${searchTerms}', 1);
INSERT INTO site (id, name, url, active)
VALUES (9, 'Shopee Mexico', 'https://shopee.com.mx/search?keyword=${searchTerms}', 1);
INSERT INTO site (id, name, url, active)
VALUES (10, 'Shopee Colombia', 'https://shopee.com.co/search?keyword=${searchTerms}', 1);
INSERT INTO site (id, name, url, active)
VALUES (11, 'Shopee Chile', 'https://shopee.cl/search?keyword=${searchTerms}', 1);
INSERT INTO site (id, name, url, active)
VALUES (12, 'Tokopedia', 'https://www.tokopedia.com/search?st=product&q=${searchTerms}', 1);
INSERT INTO site (id, name, url, active)
VALUES (13, 'Carousell', 'https://www.carousell.sg/', 1);
INSERT INTO site (id, name, url, active)
VALUES (14, 'Bukalapak', 'https://www.bukalapak.com/products?search%5Bkeywords%5D=${searchTerms}', 1);
INSERT INTO site (id, name, url, active)
VALUES (15, 'Lazada Indonesia', 'https://www.lazada.co.id/', 0);
INSERT INTO site (id, name, url, active)
VALUES (16, 'Lazada Malaysia', 'https://www.lazada.com.my/', 0);
INSERT INTO site (id, name, url, active)
VALUES (17, 'Lazada Singapore', 'https://www.lazada.sg/', 0);
INSERT INTO site (id, name, url, active)
VALUES (18, 'Lazada Vietnam', 'https://www.lazada.vn/', 0);
INSERT INTO site (id, name, url, active)
VALUES (19, 'Lazada Thailand', 'https://www.lazada.co.th/', 0);
INSERT INTO site (id, name, url, active)
VALUES (20, 'Lazada Philippines', 'https://www.lazada.com.ph/', 0);
INSERT INTO site (id, name, url, active)
VALUES (21, 'Alibaba', 'https://www.alibaba.com/', 1);
