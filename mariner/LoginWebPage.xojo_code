...
Begin WebPage LoginWebPage
   ...
   Begin WebRectangle SidebarRectangle
      ...
      End
   End
   Begin LoginContainer UserLoginContainer
      ControlCount    =   0
      ControlID       =   ""
      Enabled         =   True
      Height          =   257
...
#tag WindowCode
	...
	#tag Event
		Sub Resized()
		  Var loginForm As LoginContainer = UserLoginContainer
		  loginForm.Left = (Me.Width / 2) - (loginForm.Width / 2)
		  loginForm.Top = (Me.Height / 3) - (loginForm.Height / 2)
		End Sub
	#tag EndEvent
